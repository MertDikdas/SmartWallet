...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleAccountBalanceNotZero(
            AccountBalanceNotZeroException exception,
            HttpServletRequest request
    ) {
        ApiError error = new ApiError(
                Instant.now(),
    ...
    public ResponseEntity<ApiError> handleRecurringTransactionNotFoundException(
            RecurringTransactionNotFoundException exception,
            HttpServletRequest request
    ){
        ApiError error = new ApiError(
                Instant.now(),
    ...
    handleRecurringTransactionCategoryMismatch(
            RecurringTransactionCategoryMismatchException exception,
            HttpServletRequest request
    ) {
        ApiError error = new ApiError(
                Instant.now(),
    ...
    @ExceptionHandler(
            InvalidRecurringTransactionStateException.class
    )
    public ResponseEntity<ApiError>
    handleInvalidRecurringTransactionState(
            InvalidRecurringTransactionStateException exception,
            HttpServletRequest request
    ) {
        ApiError error = new ApiError(
                Instant.now(),
